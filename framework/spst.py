import framework.graph as graph
from framework.graph_io import load_graph, write_dot  # graphIO import graphs.py, so we do not need to import it here.
import os
import math
...
# TestInstances=["graph1000", "graph2000", "graph4000", "graph8000"];	WriteDOTFiles=False
